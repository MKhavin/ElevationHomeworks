...
export const WIZARDS_DATA = [
  ...
  },
  {
    ...
    img: 'https://upload.wikimedia.org/wikipedia/en/e/e8/Dumbledore_-_Prisoner_of_Azkaban.jpg',
    level: 'Advanced',
    description: 'Prof. Albus Percival Wulfric Brian Dumbledore is a fictional character in J. K. Rowling`s Harry Potter series. For most of the series, he is the headmaster of the wizarding school Hogwarts. As part of his backstory, it is revealed that he is the founder and leader of the Order of the Phoenix, an organisation dedicated to fighting Lord Voldemort, the main antagonist of the series.'
  }
];

export const HERBOLOGY_DATA = [
  {
    name: 'Puffapod',
    img: 'https://static.wikia.nocookie.net/harrypotter/images/2/2f/PuffapodHM.png',
    level: 'Beginner',
    description: 'A Puffapod was a magical plant that produced large pink seedpods full of shining beans, which instantly flowered when they came into contact with any solid object.'
  },
  {
    name: 'Wormwood',
    img: 'https://static.wikia.nocookie.net/harrypotter/images/8/87/WormwoodWU.png',
    level: 'Beginner',
    description: 'Wormwood (Artemisa absinthium) is a very bitter herb that had been used in potion-making since ancient times.'
  }
];